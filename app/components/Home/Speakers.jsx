    ...
    <div className="relative bg-gradient-to-br from-gray-900/5 via-gray-50 to-white py-24 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(46,139,87,0.08) 0%, rgba(46,139,87,0.03) 40%, transparent 70%)",
          }}
          animate={{
            scale: [1, 1.1, 1],
            opacity: [0.5, 0.7, 0.5],
        ...
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(255,107,0,0.08) 0%, rgba(255,107,0,0.03) 40%, transparent 70%)",
          }}
          animate={{
            scale: [1, 1.15, 1],
            opacity: [0.5, 0.7, 0.5],
        ...
        <div className="text-center mb-16">
          ...
          >
            <div className="px-5 py-1.5 rounded-full bg-gradient-to-r from-[#2E8B57]/20 to-[#FF6B00]/20 text-[#2E8B57] text-sm font-medium inline-block border border-[#2E8B57]/20 backdrop-blur-md shadow-lg shadow-[#2E8B57]/5">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#2E8B57] to-[#FF6B00] font-semibold tracking-wider">
                FEATURED SPEAKERS
              </span>
            </div>
          </motion.div>
          ...
          >
            Learn from leading experts who are shaping the future of education
            and technology. Our speakers bring diverse perspectives and
            groundbreaking insights to the Festival of Change.
          </motion.p>
        </div>
                    ...
                    <div className="w-full h-full bg-gray-200 relative">
                      ...
                      <div className="absolute inset-0 opacity-[0.1] mix-blend-overlay">
                        ...
                        >
                          ...
                          >
                            <path
                              d="M10,50 L40,50 L45,45 L50,50 L90,50"
                              stroke="white"
                              strokeWidth="0.5"
                              fill="none"
                            />
                            <path
                              d="M50,10 L50,40 L45,45 L50,50 L50,90"
                              stroke="white"
                              strokeWidth="0.5"
                              fill="none"
                            />
          ...
          >
            <div className="flex items-center justify-center flex-wrap gap-8 lg:gap-10">
              {pastSpeakers.map((speaker, index) => (
                <motion.div
                  key={index}
                  className="w-full md:w-[16rem] relative bg-gradient-to-br from-white/80 to-white/60 backdrop-blur-lg rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500"
                  style={{
                    borderTop: "1px solid rgba(255,255,255,0.8)",
                    borderLeft: "1px solid rgba(255,255,255,0.8)",
                  }}
