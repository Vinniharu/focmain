  ...
  const teamMembers = [
    {
      ...
      position: "Convener",
      image: "/images/adeyinka.jpg",
    },
    {
      name: "Doyinsola Faith Owolabi",
      position: "Program Director",
      image: "/images/doyin.jpg", 
    },
    {
      name: "Emmanuella Adesuwa Onyekwere",
      position: "Project Manager",
      image: "/images/adesuwa.jpg",
    },
    {
      name: "Anjolaoluwa Akinbote", 
      position: "Project Assistant",
      image: "/images/anjola.jpg",
    },
    {
      name: "Daniel Oreofe",
      position: "Partnership Manager",
      image: "/images/oreofe.jpg",
    },
  ];
  ...
  return (
    <div id="team" className="relative bg-gray-900 overflow-hidden py-32">
      ...
      >
        ...
        <motion.div
          className="flex flex-wrap items-center justify-center gap-x-8 gap-y-16 mt-12 relative"
        ...
        >
          {teamMembers.map((member, index) => (
            <motion.div
              key={index}
              className="relative group perspective-1000 w-full md:w-[24rem]"
            ...
            >
              ...
              <div className="pt-8 pb-6 px-6 flex flex-col items-center relative z-10 rounded-xl bg-gray-900/20 backdrop-blur-xl">
                ...
                <motion.div
                  className="w-48 h-48 rounded-full overflow-hidden mb-6 ring-2 ring-white/10 shadow-lg relative"
                  whileHover={{ scale: 1.05 }}
                  transition={{ duration: 0.4 }}
                >
                  <div
                    style={{ backgroundImage: member.image ? `url(${member.image})` : `url(/profile.jpg)` }}
                    className="w-full h-full bg-cover bg-center absolute"
                  />

                  {/* Futuristic overlay for photos */}
                  <motion.div className="absolute inset-0 bg-gradient-to-tr from-[#2E8B57]/30 to-[#FF6B00]/30 group-hover:opacity-80 transition-opacity duration-300" />

                  {/* Scan line effect */}
                  <motion.div className="absolute inset-0 overflow-hidden opacity-0 group-hover:opacity-40">
                    <motion.div
